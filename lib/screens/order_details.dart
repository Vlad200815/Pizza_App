  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: LiquidPullToRefresh(
        ...
        child: BlocListener<my_form_bloc.FormBloc, my_form_bloc.FormState>(
                  ...
                  actions: [
                    const Center(
                      child: Padding(
                        ...
                        child: Text(
                          "Your pizza will be sent\nin less than 30 minuts",
                          style: TextStyle(
                            fontWeight: FontWeight.w600,
                            color: Color.fromARGB(255, 103, 89, 89),
                            fontSize: 16,
                          ),
                        ),
                      ),
                      ...
                      children: [
                        ...
                        MyButton(
                          ...
                          onPressed: () {
                            ...
                            // context.read<CartBloc>().add(DeleteAllPizzaEvent());
                          },
                        ),
                      ],
                    ),
